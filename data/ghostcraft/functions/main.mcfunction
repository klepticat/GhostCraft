execute as @e[type=armor_stand,tag=NPC,tag=NPC_Active,tag=Quest_NPC] at @s run function ghostcraft:display/questmarker
execute as @e[type=armor_stand,tag=NPC,tag=NPC_Active,tag=Help_NPC] at @s run function ghostcraft:display/helpmarker
execute as @e[type=armor_stand,tag=NPC,tag=NPC_Active,tag=Dialogue_NPC] at @s run function ghostcraft:display/dialoguemarker
